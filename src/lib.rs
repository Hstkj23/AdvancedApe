// src/lib.rs
/*
 * Core library for ApeCastScribble
 */
...
#[derive(Debug)]
pub struct ApeCastScribbleProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ApeCastScribbleProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ApeCastScribble processing");
    
    let mut processor = ApeCastScribbleProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ApeCastScribbleProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ApeCastScribbleProcessor::new(false);
